                ...
                <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                    ...
                    <div class="caption custom-caption">
                        ...
                        <h6 class="custom-title hidden-sm hidden-md hidden-lg hidden-xl hidden-xxl">
                            ...
                            <p><a href="record_kg.php" class="btn btn-primary custom-btn-primary"> التسجيل</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                    ...
                    <div class="caption custom-caption">
                        ...
                        <h6 class="custom-title hidden-sm hidden-md hidden-lg hidden-xl hidden-xxl">
                            ...
                            <p><a href="record_primary.php" class="btn btn-primary custom-btn-primary"> التسجيل</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                    ...
                    <div class="caption custom-caption">
                        ...
                        <h6 class="custom-title hidden-sm hidden-md hidden-lg hidden-xl hidden-xxl">
                            ...
                            <p><a href="record_preparatory.php" class="btn btn-primary custom-btn-primary"> التسجيل</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                    ...
                    <div class="caption custom-caption">
                        ...
                        <h6 class="custom-title hidden-sm hidden-md hidden-lg hidden-xl hidden-xxl">
                            ...
                            <p><a href="record_secondary.php" class="btn btn-primary custom-btn-primary"> التسجيل</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                    ...
                    <div class="caption custom-caption">
                        ...
                        <h6 class="custom-title hidden-sm hidden-md hidden-lg hidden-xl hidden-xxl">
                            ...
                            <p><a href="record_institute.php" class="btn btn-primary custom-btn-primary"> التسجيل</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                    ...
                    <div class="caption custom-caption">
                        ...
                        <h6 class="custom-title hidden-sm hidden-md hidden-lg hidden-xl hidden-xxl">
                            ...
                            <p><a href="record_university.php" class="btn btn-primary custom-btn-primary"> التسجيل</a></p>
                        </div>
                    </div>
                </div>
            </div>
